        ...
        return (
            <Modal style={styles.modal}>
                ...
                <p>
                    ...
                    <Link to='/Add' style={styles.Link}><button className={this.state.canAdd ? 'okButton' : 'okButtonDisabled'} disabled={!this.state.canAdd} onClick={this.Add}>Add</button></Link>
